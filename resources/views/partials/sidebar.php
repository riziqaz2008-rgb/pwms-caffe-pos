        ...
        <div class="flex flex-col h-full overflow-y-auto border-e border-gray-200/50 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <ul class="flex flex-col items-start h-screen my-5 px-5">
                <div class="w-full">
                        ...
                        <div class="grid transition-all duration-300 ease-out"
                            ...
                            <div class="overflow-hidden">
                                <div class="ml-5 mt-2 pl-4 border-l-2 border-gray-100 space-y-1">
                                    ...
                                    <a href="?route=menu/kategori" class="font-medium <?= $route === "menu/kategori" ? 'flex items-center gap-x-3 text-primary px-4 py-4 rounded-2xl' : 'flex items-center gap-3 px-4 py-3 rounded-lg text-gray-400/80 hover:bg-black/5 transition-all' ?>">
                    ...
                    <li>
                        <a href="?route=transaksi" class="relative flex justify-start items-center px-4 py-4 rounded-2xl gap-4 mb-8 <?= $route === "transaksi" ? 'bg-gray-50 text-primary font-bold' : 'text-gray-400/80 hover:bg-black/5 duration-300 transition-all ease-in-out' ?>">
                        ...
                        <div class="grid transition-all duration-300 ease-out"
                            ...
                            <div class="overflow-hidden">
                                <div class="ml-5 mt-2 pl-4 border-l-2 border-gray-100 space-y-1">
                                    ...
                                    <a href="?route=pelanggan" class="<?= $route === "pelanggan" ? 'flex items-center gap-x-3 font-medium text-primary px-4 py-4 rounded-2xl' : 'flex items-center gap-3 px-4 py-3 rounded-lg text-gray-400/80 hover:bg-black/5 transition-all' ?>">

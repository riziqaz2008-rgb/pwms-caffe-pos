        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 mt-8">
            <div class="lg:col-span-full space-y-6">
                <div class="bg-white rounded-2xl p-6 lg:p-7">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea
                                rows="3"
                                class="w-full px-4 py-3 rounded-lg border border-gray-200 bg-white text-sm font-medium text-[#12131a] outline-none focus:ring-primary focus:ring-2 transition resize-none">Jl. Pandan Wangi, Samarinda</textarea>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl  p-6 lg:p-7">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-5 p-4 rounded-lg border border-gray-100 bg-gray-50/50">
                                <div class="w-20 h-20 rounded-2xl bg-white border border-gray-200 p-2 flex items-center justify-center shrink-0 relative group">
                                    <div class="w-12 h-12 rounded-lg bg-primary flex items-center justify-center text-white font-black text-xl">
                                        <i class="bx bx-hexagon"></i>
                                    </div>
                                </div>
                                <div class="flex-1">
                                    <div class="flex flex-wrap items-center gap-3">
                                        <label class="px-4 py-2.5 rounded-lg bg-primary hover:bg-blue-700 text-white text-sm font-bold cursor-pointer transition flex items-center gap-2">
                                            <i class="bx bx-upload text-base"></i>
                                            Unggah Logo Baru
                                            <input type="file" class="hidden" accept="image/png, image/jpeg, image/svg+xml">
                                        </label>

                                        <button type="button" class="px-4 py-2.5 rounded-lg border border-gray-200 bg-white text-sm font-bold text-red-600 hover:bg-red-50 transition">
                                            Hapus
                                        </button>
                                    </div>
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap items-center gap-4">
                                <label class="cursor-pointer relative">
                                    ...
                                    <div class="w-10 h-10 rounded-lg bg-indigo-600 flex items-center justify-center text-white ring-2 ring-offset-2 ring-transparent peer-checked:ring-indigo-600 transition">
                                ...
                                <label class="cursor-pointer relative">
                                    ...
                                    <div class="w-10 h-10 rounded-lg bg-emerald-600 flex items-center justify-center text-white ring-2 ring-offset-2 ring-transparent peer-checked:ring-emerald-600 transition">
                                        <i class="bx bx-check text-lg opacity-0 peer-checked:opacity-100"></i>
                                    </div>
                                </label>
                                <label class="cursor-pointer relative">
                                    <input type="radio" name="theme_color" value="#7C3AED" class="sr-only peer">
                                    <div class="w-10 h-10 rounded-lg bg-violet-600 flex items-center justify-center text-white ring-2 ring-offset-2 ring-transparent peer-checked:ring-violet-600 transition">
                                        <i class="bx bx-check text-lg opacity-0 peer-checked:opacity-100"></i>
                                    </div>
                                </label>
                                <label class="cursor-pointer relative">
                                    <input type="radio" name="theme_color" value="#E11D48" class="sr-only peer">
                                    <div class="w-10 h-10 rounded-lg bg-rose-600 flex items-center justify-center text-white ring-2 ring-offset-2 ring-transparent peer-checked:ring-rose-600 transition">
                                        <i class="bx bx-check text-lg opacity-0 peer-checked:opacity-100"></i>
                                    </div>
                                </label>
                                <label class="cursor-pointer relative">
                                    <input type="radio" name="theme_color" value="#D97706" class="sr-only peer">
                                    <div class="w-10 h-10 rounded-lg bg-amber-600 flex items-center justify-center text-white ring-2 ring-offset-2 ring-transparent peer-checked:ring-amber-600 transition">
                                        <i class="bx bx-check text-lg opacity-0 peer-checked:opacity-100"></i>
                                    </div>
                                </label>
                                <div class="h-10 border-l border-gray-200 pl-4 flex items-center gap-3">
                                    ...
                                    <div class="relative flex items-center">
                                        <input type="color" id="customColor" value="#4F46E5" class="w-9 h-9 rounded-lg border border-gray-200 cursor-pointer p-0.5 bg-white">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="bg-white rounded-2xl p-6 lg:p-7">
                    ...
                    <div class="flex items-center justify-between gap-5 p-4 rounded-lg border border-gray-100 bg-gray-50/50">
                        <div class="flex items-center gap-4">
                            <div class="w-10 h-10 rounded-lg bg-white border border-gray-200 flex items-center justify-center text-gray-600">
                        ...
                        <button
                            class="px-4 py-2.5 rounded-lg border border-gray-200 bg-white text-sm font-bold text-[#12131a] hover:bg-gray-50 transition cursor-pointer">
                            Ubah Password
                        </button>
                    </div>
                </div>

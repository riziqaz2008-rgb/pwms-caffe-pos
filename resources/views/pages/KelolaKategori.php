            ...
            <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 dark:border-slate-800">
                ...
                <div class="flex items-center gap-2 w-full lg:w-auto">
                    ...
                    <button
                        type="button"
                        @click="kategori = true"
                        class="flex-1 flex items-center justify-center bg-primary text-white font-black px-5 py-3 gap-2 rounded-xl cursor-pointer whitespace-nowrap  hover:opacity-90 transition"
                    >
...
<div class="rounded-2xl p-5 my-6 bg-white dark:bg-slate-950">
                        ...
                        <tr>
                            <td colspan="3">
                                <div class="flex flex-col items-center justify-center py-12 px-4 text-center bg-gray-50">
                                    ...
                                    <button type="button" @click="kategori = true" class="px-4 py-3 bg-primary text-white text-sm font-bold rounded-xl hover:opacity-90 transition-all flex items-center gap-2">
    ...
    >
        ...
        >
            ...
            <div class="relative bg-white border border-gray-200 rounded-2xl p-5 sm:p-8 shadow-xl">
                        ...
                        <div class="flex flex-col gap-1.5 w-full">
                            ...
                            <div class="relative flex items-center w-full group">
                                ...
                                <input
                                    ...
                                    autocomplete="off"
                                    class="w-full pl-10 sm:pl-11 pr-4 py-3 bg-white text-slate-900 text-sm font-medium rounded-xl sm:rounded-2xl border-2 border-gray-200/80 focus:outline-none focus:ring-2 focus:ring-primary transition-all"
                                    required
                                >

            ...
            <div class="overflow-y-auto p-1 max-h-[700px]">
                ...
                <?php elseif ($layoutMode == 'grid'): ?>
                    ...
                    <!-- <div class="flex flex-col items-center justify-center py-12 px-4 text-center">
                        ...
                        <button type="button" @click="TambahMenu = true" class="px-4 py-3 bg-primary text-white text-sm font-bold rounded-lg hover:opacity-90 transition-all flex items-center gap-2">
                            <i class="bx bxs-plus text-base"></i>
                            <span>Tambah Menu</span>
                        </button>
                    </div>     -->
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-x-6 gap-y-5">
                        <div class="flex flex-col gap-1.5 w-full min-w-0">
                            ...
                            <div class="relative flex items-center w-full group">
                                ...
                                <input type="text" name="namaBarang" maxlength="100" id="globalModalInput" placeholder="Contoh: Nasi Goreng Special" autocomplete="off" class="w-full pl-10 sm:pl-11 pr-4 py-3 bg-white text-slate-900 text-sm font-medium rounded-lg border-2 border-gray-200/80 focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary transition-all" required>
                            </div>
                        </div>
                        <div class="flex flex-col gap-1.5 w-full min-w-0">
                            ...
                            <div class="relative flex items-center w-full group">
                                ...
                                <input type="text" inputmode="numeric" name="hargaBarang" id="hargaJual" maxlength="9" placeholder="Contoh: 50000" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/\B(?=(\d{3})+(?!\d))/g, '.')" class="w-full pl-10 sm:pl-11 pr-4 py-3 bg-white text-slate-900 text-sm font-medium rounded-lg border-2 border-gray-200/80 focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary transition-all" required>
                            </div>
                        </div>
                        <div class="flex flex-col gap-1.5 w-full min-w-0">
                            ...
                            <div class="relative flex items-center w-full group">
                                ...
                                <select name="kategoriBarang" id="kategoriTambah" required class="w-full pl-10 sm:pl-11 pr-10 py-3 bg-white text-slate-900 text-sm font-medium rounded-lg border-2 border-gray-200/80 focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary appearance-none cursor-pointer transition-all">
                        ...
                        <div class="flex flex-col gap-1.5 w-full col-span-1 lg:col-span-2 xl:col-span-2 min-w-0">
                            <div class="flex items-center justify-between p-4 sm:p-5 bg-gray-50 rounded-lg border border-gray-200/80">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer shrink-0">
                                    <input type="checkbox" name="status_tersedia" value="1" class="sr-only peer" checked>

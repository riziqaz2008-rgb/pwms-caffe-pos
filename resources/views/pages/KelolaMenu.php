<section id="Menu" x-data="{ 
        ...
        <div class="w-full">
            ...
            <div id="emptyMenuState" class="hidden bg-white rounded-l p-12 text-center mt-6">
                <div class="w-14 h-14 mx-auto rounded-l bg-gray-100 flex items-center justify-center">
                ...
                <button type="button" onclick="resetMenuFilter()"
                    class="mt-5 px-5 py-2.5 rounded-lg bg-primary text-white text-sm font-bold hover:bg-red-500 transition-all">
                    Reset Filter
                </button>
            </div>
                        ...
                        <div class="flex flex-col gap-1.5 w-full group col-span-1 lg:col-span-2 xl:col-span-3 min-w-0">
                            ...
                            <div class="relative flex w-full h-full">
                                ...
                                <textarea
                                    ...
                                    class="w-full pl-10 sm:pl-11 pr-4 py-3 bg-white text-slate-900 text-sm font-medium rounded-lg sm:rounded-l border-2 border-gray-200/80 focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary resize-y transition-all"
                                ></textarea>
                            </div>
                        </div>
